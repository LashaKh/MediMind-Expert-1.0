  ...
  tour: {
    ...
    calculators: {
      hero: {
        ...
        subtitle: 'Калькуляторы мирового уровня, основанные на доказательствах, с 100% валидацией и клинической точностью'
      },
      stats: {
        validated: '100% валидированы',
        clinical: 'Клинического уровня',
        evidence: 'Доказательная медицина',
