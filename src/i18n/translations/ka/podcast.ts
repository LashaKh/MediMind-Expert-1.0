export const podcast = {
  ...
  subtitle: 'გარდაქმენით თქვენი სამედიცინო დოკუმენტები მომხიბლავ, პროფესიონალურ პოდკასტებად რევოლუციური AI ტექნოლოგიითა და სტუდიის ხარისხის ბუნებრივი ხმებით.',
  ...
  comingSoon: {
    ...
    subtitle: 'რა მოგელით:',
    features: {
      analysis: 'ინტელექტუალური სამედიცინო შინაარსის ანალიზი',
      voices: 'ბუნებრივი ხმის სინთეზი ექსპერტული ინტონაციით',
      languages: 'მრავალენოვანი მხარდაჭერა',
      quality: 'პროფესიონალური აუდიო ხარისხი',
      speed: 'სწრაფი გენერაცია წუთებში'
    }
  },

  // Hero Section
  hero: {
    createStunning: 'შექმენით მომხიბლავი',
    aiPodcasts: 'AI პოდკასტები',
    getStarted: 'დაიწყეთ'
  },

  // Feature Pills
  pills: {
    neuralAnalysis: 'ნეირონული ანალიზი',
    studioQuality: 'სტუდიის ხარისხი',
    lightningFast: 'მეხის სიჩქარე'
  },

  // Features Section
  featuresSection: {
    title: 'რატომ აირჩიოთ AI პოდკასტ სტუდია?',
    subtitle: 'განიცადეთ სამედიცინო კონტენტის შექმნის მომავალი ჩვენი მოწინავე AI ტექნოლოგიით',
    intelligentAnalysis: {
      title: 'ინტელექტუალური შინაარსის ანალიზი',
      description: 'მოწინავე AI ესმის კომპლექსური სამედიცინო დოკუმენტები და ქმნის თანმიმდევრულ ნარატივებს'
    },
    naturalVoices: {
      title: 'ბუნებრივი ხმის სინთეზი',
      description: 'პროფესიონალური სამედიცინო ექსპერტების ხმები ბუნებრივი ინტონაციითა და სიმკაფით'
    },
    fastGeneration: {
      title: 'მეხის სიჩქარის გენერაცია',
      description: 'მიიღეთ თქვენი პოდკასტი წუთებში, არა საათებში თუ დღეებში'
    }
  },
  ...
  navigation: {
    ...
    headerDesc: 'გარდაქმენით თქვენი სამედიცინო ცოდნა მომხიბლავ აუდიო გამოცდილებად'
  },
