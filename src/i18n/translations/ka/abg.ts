const abg = {
  ...
  analysis: {
    ...
    error: {
      ...
      service503: 'AI სერვისი დროებით მიუწვდომელია (503). ეს ჩვეულებრივ რამდენიმე წუთში აღდგება. გთხოვთ სცადოთ ხელახლა.',
      rateLimit: 'ლიმიტი გადაჭარბებულია. გთხოვთ დაელოდოთ მომენტს და სცადოთ ხელახლა.',
      quotaExhausted: 'API კვოტა ამოწურულია დღეს. გთხოვთ სცადოთ ხვალ ან დაუკავშირდეთ მხარდაჭერას.',
      geminiError: 'AI ანალიზის სერვისის შეცდომა: {{message}}. ეს ალბათ დროებითია - გთხოვთ სცადოთ რამდენიმე წუთში.',
      unexpectedInterpretation: 'ინტერპრეტაციის დროს მოულოდნელი შეცდომა მოხდა',
      unexpectedActionPlan: 'ქმედების გეგმის გენერაციისას მოულოდნელი შეცდომა მოხდა'
    },
