        ...
        <div className="flex items-center justify-between mb-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              variant="outline"
              size="sm"
              data-tour="abg-new-session-button"
              className="
                relative group overflow-hidden
                bg-gradient-to-r from-[#63b3ed] to-[#2b6cb0]
                hover:from-[#2b6cb0] hover:to-[#1a365d]
                border-0 text-white
                shadow-lg hover:shadow-xl hover:shadow-[#63b3ed]/25
                ...
                focus:outline-none
              "
              aria-label={t('abg.header.newSessionAria', 'Start new analysis session')}
            >
              <div className="relative z-10 flex items-center">
                <Plus className="h-4 w-4 mr-2 transition-transform duration-300 group-hover:rotate-90" />
                <span className="relative">
                  {t('abg.header.newSession', 'New Session')}
