      ...
      <div className={cn("abg-premium", className)}>
        <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl border border-[var(--glass-border-light)] shadow-lg">
          <div className="p-8 text-center">
            ...
            <p className="text-[var(--foreground-tertiary)]">{t('abg.actionPlan.none', 'No action plan available')}</p>
          </div>
        </div>
      </div>
    );
    ...
    <div className={cn(
      ...
      <div className="space-y-6">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-emerald-600 via-blue-600 to-purple-600 rounded-2xl shadow-2xl">
          ...
          <div className="relative p-8 text-[var(--foreground)]">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-16 h-16 bg-[var(--component-card)]/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                    <ClipboardList className="h-8 w-8 text-[var(--foreground)]" />
                  </div>
                ...
                <div>
                  ...
                  <p className="text-[var(--foreground)]/80">Personalized treatment recommendations and care protocols</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <Button
                  variant="ghost"
                  size="sm"
                  className="text-[var(--foreground)] hover:bg-[var(--component-card)]/20 border border-white/20"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="bg-[var(--component-card)]/10 rounded-xl p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl flex items-center justify-center">
                    <Target className="h-6 w-6 text-[var(--foreground)]" />
                  </div>
                  <div>
                    <p className="text-[var(--foreground)]/80 text-sm">Total Actions</p>
              ...
              <div className="bg-[var(--component-card)]/10 rounded-xl p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  <div className={`w-12 h-12 bg-gradient-to-br ${overallPriorityConfig.gradient} rounded-xl flex items-center justify-center`}>
                    <overallPriorityConfig.icon className="h-6 w-6 text-[var(--foreground)]" />
                  </div>
                  <div>
                    <p className="text-[var(--foreground)]/80 text-sm">Priority</p>
              ...
              <div className="bg-[var(--component-card)]/10 rounded-xl p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center">
                    <CheckCircle2 className="h-6 w-6 text-[var(--foreground)]" />
                  </div>
                  <div>
                    <p className="text-[var(--foreground)]/80 text-sm">Completed</p>
              ...
              <div className="bg-[var(--component-card)]/10 rounded-xl p-4 backdrop-blur-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[var(--foreground)]/80 text-sm">Progress</p>
            ...
            {totalActions > 0 && (
              <div className="mt-6">
                ...
                <div className="w-full bg-[var(--component-card)]/20 rounded-full h-3 overflow-hidden">
                  <div 
        ...
        {actionPlan.clinicalGoals && actionPlan.clinicalGoals.length > 0 && (
          <div className="bg-[var(--component-card)] rounded-2xl border border-[var(--glass-border-light)] shadow-xl p-6">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center">
                <Star className="h-6 w-6 text-[var(--foreground)]" />
              </div>
              <div>
                <h3 className="text-xl font-bold text-[var(--foreground)]">Clinical Goals</h3>
                <p className="text-[var(--foreground-tertiary)]">Target outcomes and treatment objectives</p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          {Object.entries(actionsByCategory).map(([categoryKey, actions]) => {
            ...
            return (
              <div key={categoryKey} className="bg-[var(--component-card)] rounded-2xl border border-[var(--glass-border-light)] shadow-xl overflow-hidden">
                <div 
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <div className={`w-12 h-12 bg-gradient-to-br ${config.gradient} rounded-xl flex items-center justify-center`}>
                        <config.icon className="h-6 w-6 text-[var(--foreground)]" />
                      </div>
                      <div>
                        <h3 className="text-xl font-bold text-[var(--foreground)]">{config.label}</h3>
                        <p className="text-[var(--foreground-tertiary)]">{config.description}</p>
                      </div>
                    </div>
                    
                    <div className="flex items-center gap-4">
                      <div className="text-right">
                        <p className="text-sm text-[var(--foreground-tertiary)]">{categoryCompletedCount}/{actions.length} completed</p>
                        <div className="w-24 h-2 bg-[var(--component-surface-tertiary)] rounded-full overflow-hidden mt-1">
                          <div 
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            ...
                            isCompleted ? "bg-green-50 border-green-200" : "bg-[var(--component-card)] border-[var(--glass-border-light)] hover:border-[var(--glass-border-medium)]"
                          )}
                        >
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                  <h4 className={cn(
                                    ...
                                    isCompleted && "line-through text-[var(--foreground-secondary)]"
                                  )}>
                                    {action.title}
                                  </h4>
                                ...
                                <p className={cn(
                                  "text-[var(--foreground-tertiary)] leading-relaxed mb-3",
                                ...
                                <div className="flex items-center gap-4 text-sm">
                                  <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[var(--foreground-tertiary)]">{action.timeframe}</span>
                                  </div>
                                  {action.responsible && (
                                    <div className="flex items-center gap-2">
                                      <User className="h-4 w-4 text-slate-400" />
                                      <span className="text-[var(--foreground-tertiary)]">{action.responsible}</span>
                                    </div>
                                  )}
                                </div>
                              </div>
