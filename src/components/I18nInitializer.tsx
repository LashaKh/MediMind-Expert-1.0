...
export const I18nInitializer: React.FC<I18nInitializerProps> = ({ 
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[var(--component-surface-primary)]">
        <div className="max-w-md mx-auto text-center p-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-[var(--cardiology-accent-blue-dark)] text-[var(--foreground)] rounded-md hover:bg-[var(--cardiology-accent-blue-dark)] transition-colors"
          >
            Reload Application
          </button>
        </div>
