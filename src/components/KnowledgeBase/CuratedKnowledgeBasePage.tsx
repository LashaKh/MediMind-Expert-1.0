...
const cardiologyResources: KnowledgeBaseResource[] = [
  ...
  {
    id: 'cardio-book-1',
    title: "Braunwald's Heart Disease: A Textbook of Cardiovascular Medicine, 2-Volume Set: Expert Consult Premium Edition – Enhanced Online Features and Print 9th Edition",
    category: 'book',
  ...
  {
    id: 'cardio-book-2',
    title: 'Clinical Cardiology: Current Practice Guidelines Updated Edition',
    category: 'book',
  ...
  {
    id: 'cardio-book-3',
    title: 'The ESC Textbook of Intensive and Acute Cardiovascular Care (3 edn)',
    category: 'book',
  ...
  {
    id: 'cardio-book-4',
    title: 'Elias B. Hanna - Practical Cardiovascular Medicine-Wiley (2022)',
    category: 'book',
  ...
  {
    id: 'cardio-book-5',
    title: "American Society of Echocardiography (editor) - ASE's Comprehensive Echocardiography-Elsevier (2021)",
    category: 'book',
    organization: 'American Society of Echocardiography',
    year: 2021,
    description: 'Comprehensive echocardiography textbook covering all aspects of cardiac ultrasound imaging',
    tags: ['echocardiography', 'imaging', 'ultrasound', 'ASE', 'comprehensive'],
    rating: 4.8,
    citations: 4200,
    views: 27500,
    lastUpdated: '2024-01-10',
  ...
  {
    id: 'cardio-book-6',
    title: 'Antoni Bayés de Luna_ Miguel Fiol-Sala_ Antoni Bayés-Genís_ Adrian Baranchuk - Clinical Electrocardiography: A Textbook-John Wiley & Sons (2022)',
    category: 'book',
    authors: ['Antoni Bayés de Luna', 'Miguel Fiol-Sala', 'Antoni Bayés-Genís', 'Adrian Baranchuk'],
    year: 2022,
    description: 'Comprehensive clinical electrocardiography textbook with modern interpretation techniques',
    tags: ['ECG', 'electrocardiography', 'interpretation', 'clinical'],
    rating: 4.7,
    citations: 3800,
    views: 22400,
  ...
  {
    id: 'cardio-book-7',
    title: '(The European Society of Cardiology Series) A. John Camm, Thomas F. Lüscher, Gerald Maurer, Patrick W. Serruys - The ESC Textbook of Cardiovascular Medicine [2 Volume Set]-Oxford University Press (2019)',
    category: 'book',
    authors: ['A. John Camm', 'Thomas F. Lüscher', 'Gerald Maurer', 'Patrick W. Serruys'],
    organization: 'European Society of Cardiology',
    year: 2019,
    description: 'The official ESC textbook of cardiovascular medicine in comprehensive 2-volume set',
    tags: ['ESC', 'comprehensive', 'textbook', 'cardiovascular medicine', 'reference'],
    rating: 4.9,
    citations: 8700,
    views: 45600,
  ...
  {
    id: 'cardio-book-8',
    title: 'Cardiology Secrets 6th Edition by Glenn N. Levine MD FACC FAHA',
    category: 'book',
    authors: ['Glenn N. Levine'],
    year: 2024,
    description: 'Question-and-answer format covering key cardiology topics and clinical scenarios',
    tags: ['clinical pearls', 'Q&A', 'board review', 'cardiology'],
    rating: 4.6,
    citations: 2400,
    views: 18900,
  ...
  {
    id: 'cardio-book-9',
    title: 'Interpretation of cardiac pathophysiology from pressure waveform analysis-Wiley Blackwell (2018)',
    category: 'book',
    year: 2018,
    description: 'Advanced guide to interpreting cardiac pathophysiology using pressure waveform analysis',
    tags: ['hemodynamics', 'pressure waveforms', 'pathophysiology', 'catheterization'],
    rating: 4.5,
    citations: 1800,
    views: 12300,
  ...
  {
    id: 'cardio-book-10',
    title: "Goldberger's Clinical Electrocardiography: A Simplified Approach 10th Edition",
    category: 'book',
    year: 2024,
    description: 'Simplified approach to clinical electrocardiography for practical application',
    tags: ['ECG', 'simplified', 'clinical', 'interpretation'],
    rating: 4.7,
    citations: 5200,
    views: 31400,
  ...
  {
    id: 'cardio-book-11',
    title: 'George D. Dangas Interventional Cardiology: Principles and Practice-Wiley-Blackwell',
    category: 'book',
    authors: ['George D. Dangas'],
    description: 'Comprehensive interventional cardiology textbook covering principles and practice',
    tags: ['interventional', 'procedures', 'catheterization', 'PCI'],
    rating: 4.6,
    citations: 3400,
    views: 19800,
  ...
  // Guidelines
  {
    ...
    title: 'Guidelines for the interpretation of the neonatal electrocardiogram A Task Force of the European Society of Cardiology',
    category: 'guideline',
    organization: 'European Society of Cardiology',
    description: 'ESC Task Force guidelines for interpreting ECGs in neonatal patients',
    tags: ['neonatal', 'ECG', 'ESC', 'pediatric', 'interpretation'],
    rating: 4.5,
    citations: 2100,
    views: 18500,
    lastUpdated: '2024-01-15',
  ...
  },
  {
    ...
    year: 2020,
    organization: 'European Society of Cardiology',
    description: 'Management guidelines for adult patients with congenital heart conditions',
    tags: ['congenital', 'adult', 'ESC', 'heart disease', 'management'],
    rating: 4.6,
    citations: 4800,
    views: 52300,
    lastUpdated: '2024-01-10',
  ...
  },
  {
    ...
    tags: ['sports', 'exercise', 'ESC', 'rehabilitation', 'physical activity'],
    rating: 4.5,
    citations: 4200,
    views: 56700,
  ...
  },
  {
    ...
    year: 2021,
    organization: 'European Society of Cardiology',
    description: 'Comprehensive ESC guidelines for heart failure diagnosis and management',
    tags: ['heart failure', 'ESC', 'diagnosis', 'treatment', 'acute', 'chronic'],
    rating: 4.9,
    citations: 11200,
    views: 142000,
  ...
  },
  {
    ...
    tags: ['prevention', 'CVD', 'ESC', 'risk factors', 'lifestyle'],
    rating: 4.7,
    citations: 8700,
    views: 98500,
  ...
  },
  {
    ...
    year: 2022,
    organization: 'European Society of Cardiology',
    description: 'Guidelines for cardiovascular care in oncology patients',
    tags: ['cardio-oncology', 'ESC', 'cancer', 'chemotherapy', 'cardiotoxicity'],
    rating: 4.7,
    citations: 3900,
    views: 48200,
  ...
  },
  {
    ...
    year: 2022,
    organization: 'European Society of Cardiology',
    description: 'Management of ventricular arrhythmias and sudden cardiac death prevention',
    tags: ['ventricular arrhythmias', 'ESC', 'sudden cardiac death', 'ICD', 'prevention'],
    rating: 4.8,
    citations: 6100,
    views: 73400,
  ...
  },
  {
    ...
    tags: ['diabetes', 'ESC', 'cardiovascular disease', 'metabolic', 'management'],
    rating: 4.8,
    citations: 5200,
    views: 68900,
    lastUpdated: '2024-01-20',
  ...
  {
    id: 'cardio-guideline-14',
    title: '2023 Focused Update of the 2021 ESC Guidelines for the diagnosis and treatment of acute and chronic heart failure',
    category: 'guideline',
    year: 2023,
    organization: 'European Society of Cardiology',
    description: 'Focused update on heart failure management with latest evidence',
    tags: ['heart failure', 'ESC', 'focused update', 'acute', 'chronic'],
    rating: 4.7,
    citations: 4500,
    views: 62100,
    lastUpdated: '2024-01-22',
  ...
  {
    id: 'cardio-guideline-15',
    title: '2018 ESC Guidelines for the diagnosis and management of syncope',
    category: 'guideline',
    year: 2018,
    organization: 'European Society of Cardiology',
    description: 'Diagnostic and management strategies for syncope patients',
    tags: ['syncope', 'ESC', 'diagnosis', 'fainting', 'evaluation'],
    rating: 4.6,
    citations: 6700,
    views: 78300,
  ...
  {
    id: 'cardio-guideline-16',
    title: '2019 ESC Guidelines for the management of patients with supraventricular tachycardia',
    category: 'guideline',
    year: 2019,
    organization: 'European Society of Cardiology',
    description: 'Management strategies for supraventricular tachycardia',
    tags: ['SVT', 'supraventricular tachycardia', 'ESC', 'arrhythmia', 'ablation'],
    rating: 4.7,
    citations: 5800,
    views: 71200,
    lastUpdated: '2024-01-05',
  ...
  {
    id: 'cardio-guideline-17',
    title: 'The role of endomyocardial biopsy in the management of cardiovascular disease (AHA/ACCF/ESC scientific statement)',
    category: 'guideline',
    organization: 'American Heart Association',
    description: 'Scientific statement on endomyocardial biopsy indications and techniques',
    tags: ['endomyocardial biopsy', 'AHA', 'ACCF', 'ESC', 'myocarditis', 'cardiomyopathy'],
    rating: 4.5,
    citations: 3400,
    views: 32100,
    lastUpdated: '2024-01-08',
  ...
  {
    id: 'cardio-guideline-18',
    title: '2014 ESC Guidelines on the diagnosis and treatment of aortic diseases',
    category: 'guideline',
    year: 2014,
    organization: 'European Society of Cardiology',
    description: 'Comprehensive guidelines for aortic disease diagnosis and management',
    tags: ['aortic diseases', 'ESC', 'aortic dissection', 'aneurysm', 'diagnosis'],
    rating: 4.6,
    citations: 8200,
    views: 92400,
  ...
  {
    id: 'cardio-guideline-19',
    title: '2015 ESC Guidelines for the diagnosis and management of pericardial diseases',
    category: 'guideline',
    year: 2015,
    organization: 'European Society of Cardiology',
    description: 'Guidelines for pericardial disease diagnosis and treatment',
    tags: ['pericardial diseases', 'ESC', 'pericarditis', 'effusion', 'tamponade'],
    rating: 4.5,
    citations: 6900,
    views: 67800,
  ...
  },
  {
    ...
    year: 2017,
    organization: 'European Society of Cardiology',
    description: 'Comprehensive guidelines for peripheral arterial disease management',
    tags: ['peripheral arterial disease', 'ESC', 'ESVS', 'PAD', 'vascular'],
    rating: 4.6,
    citations: 7100,
    views: 81200,
  ...
  {
    id: 'cardio-guideline-21',
    title: '2018 ESC/ESH Guidelines for the management of arterial hypertension',
    category: 'guideline',
    year: 2018,
    organization: 'European Society of Cardiology',
    description: 'Comprehensive hypertension management guidelines',
    tags: ['hypertension', 'ESC', 'ESH', 'blood pressure', 'management'],
    rating: 4.8,
    citations: 14200,
    views: 178000,
  ...
  {
    id: 'cardio-guideline-22',
    title: '2018 ESC Guidelines for the management of cardiovascular diseases during pregnancy',
    category: 'guideline',
    year: 2018,
    organization: 'European Society of Cardiology',
    description: 'Management of cardiovascular conditions in pregnant patients',
    tags: ['pregnancy', 'ESC', 'maternal', 'cardiovascular disease', 'obstetric'],
    rating: 4.7,
    citations: 5600,
    views: 64300,
  ...
  },
  {
    ...
    tags: ['revascularization', 'ESC', 'EACTS', 'PCI', 'CABG', 'coronary'],
    rating: 4.8,
    citations: 9800,
    views: 124000,
    lastUpdated: '2024-01-11',
  ...
  },
  {
    ...
    tags: ['pulmonary embolism', 'ESC', 'ERS', 'PE', 'thromboembolism'],
    rating: 4.7,
    citations: 8100,
    views: 98700,
    lastUpdated: '2024-01-09',
  ...
  {
    id: 'cardio-guideline-25',
    title: '2019 ESC Guidelines for the diagnosis and management of chronic coronary syndromes',
    category: 'guideline',
    year: 2019,
    organization: 'European Society of Cardiology',
    description: 'Management of chronic coronary syndromes and stable ischemic heart disease',
    tags: ['chronic coronary syndromes', 'ESC', 'stable CAD', 'ischemic heart disease'],
    rating: 4.7,
    citations: 7800,
    views: 94300,
  ...
  {
    id: 'cardio-guideline-26',
    title: '2019 ESC/EAS Guidelines for the management of dyslipidaemias: lipid modification to reduce cardiovascular risk',
    category: 'guideline',
    year: 2019,
    organization: 'European Society of Cardiology',
    description: 'Lipid management guidelines for cardiovascular risk reduction',
    tags: ['dyslipidaemia', 'ESC', 'EAS', 'cholesterol', 'lipids', 'statin'],
    rating: 4.8,
    citations: 10200,
    views: 132000,
    lastUpdated: '2024-01-12',
  ...
  {
    id: 'cardio-guideline-27',
    title: 'ESC Fourth universal definition of myocardial infarction (2018)',
    category: 'guideline',
    year: 2018,
    organization: 'European Society of Cardiology',
    description: 'Fourth universal definition of myocardial infarction with diagnostic criteria',
    tags: ['myocardial infarction', 'ESC', 'definition', 'troponin', 'diagnosis', 'MI'],
    rating: 4.9,
    citations: 16800,
    views: 198000,
  ...
  {
    id: 'cardio-guideline-28',
    title: '2022 AHA/ACC/HFSA Guideline for the Management of Heart Failure',
    category: 'guideline',
    year: 2022,
    organization: 'American Heart Association',
    description: 'Comprehensive AHA/ACC/HFSA guidelines for heart failure diagnosis and management',
