      ...
      <div className="relative group h-full flex flex-col">
        ...
        <div className="relative h-full flex flex-col p-1">
          ...
          {attachedFiles.length > 0 && (
            <div className="mb-4">
              <div className="bg-[var(--component-card)]/60 dark:bg-[var(--background)]/60 backdrop-blur-xl rounded-2xl border border-purple-200/50 dark:border-purple-600/50 p-4">
          ...
          <div className="flex-1 relative overflow-hidden">
            <div className="h-full bg-[var(--component-card)]/80 dark:bg-[var(--background)]/80 backdrop-blur-sm rounded-2xl border border-indigo-200/60 dark:border-indigo-600/60 shadow-inner shadow-indigo-900/5 dark:shadow-black/20 overflow-hidden">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className={`
                      ...
                      ${isRecordingContext 
                        ? 'bg-gradient-to-r from-red-500 via-rose-600 to-red-600 hover:from-red-600 hover:via-rose-700 hover:to-red-700 text-[var(--foreground)] shadow-red-500/30' 
                        : 'bg-gradient-to-r from-indigo-500 via-purple-600 to-indigo-600 hover:from-indigo-600 hover:via-purple-700 hover:to-indigo-700 text-[var(--foreground)] shadow-indigo-500/30'
                      }
                    `}
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-[var(--component-card)]/80 dark:bg-[var(--card)]/80 backdrop-blur-sm border border-indigo-200/50 dark:border-indigo-600/50 rounded-lg text-indigo-700 dark:text-indigo-300 text-xs font-medium hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition-all duration-300 flex items-center space-x-1.5"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-[var(--foreground)] rounded-lg shadow-md shadow-purple-500/30 transition-all duration-300 flex items-center space-x-1.5 text-xs font-medium"
                  >
              ...
              <div className="relative h-[calc(100%-56px)] p-0">
                <textarea
                  ...
                  className="w-full h-full resize-none bg-transparent text-[var(--foreground)] dark:text-slate-100 px-6 py-4 focus:outline-none text-base leading-relaxed overflow-y-auto selection:bg-indigo-200/60 dark:selection:bg-indigo-800/60 selection:text-indigo-900 dark:selection:text-indigo-100"
                ...
                {/* Status Overlays */}
                {isRecordingContext && (
                  <div className="absolute top-4 right-4 flex items-center space-x-2 bg-gradient-to-r from-red-500/95 to-rose-600/95 backdrop-blur-xl px-4 py-2 rounded-xl text-[var(--foreground)] shadow-lg shadow-red-500/30">
                    <div className="relative">
                      <div className="w-2 h-2 bg-[var(--component-card)] rounded-full animate-pulse" />
                      <div className="absolute inset-0 w-2 h-2 bg-[var(--component-card)]/70 rounded-full animate-ping" />
                    </div>
                ...
                {isContextTranscribing && !isRecordingContext && (
                  <div className="absolute top-4 right-4 flex items-center space-x-2 bg-gradient-to-r from-indigo-500/95 to-purple-600/95 backdrop-blur-xl px-4 py-2 rounded-xl text-[var(--foreground)] shadow-lg shadow-indigo-500/30">
                  ...
                  <div className="absolute top-4 right-4 flex items-center space-x-2 bg-gradient-to-r from-red-500/95 to-rose-600/95 backdrop-blur-xl px-4 py-2 rounded-xl text-[var(--foreground)] shadow-lg shadow-red-500/30">
                    ...
                    {onClearError && (
                      <button
                        ...
                        className="text-[var(--foreground)]/80 hover:text-[var(--foreground)] hover:bg-[var(--component-card)]/20 p-1 rounded-lg transition-all duration-300"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    )}
