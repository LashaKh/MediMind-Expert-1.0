...
export const TabNavigation: React.FC<TabNavigationProps> = ({
  ...
  return (
    <div className="transcription-card-glass border-b border-white/20">
            ...
            {onToggleHistory && (
              ...
              >
                <div className="w-5 h-5 rounded-md bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center">
                  <History className="w-3 h-3 text-[var(--foreground)]" />
                </div>
                ...
                {sessionCount > 0 && !isHistoryOpen && (
                  <div className="absolute -top-1 -right-1 bg-red-500 text-[var(--foreground)] rounded-full w-4 h-4 flex items-center justify-center text-[10px] font-bold">
            ...
            {activeTab === 'transcript' && (onStartRecording || onStopRecording) && (
              <button
                ...
                className={`
                  ...
                  ${isRecording 
                    ? (canStop 
                        ? 'bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-[var(--foreground)] shadow-lg shadow-red-600/40' 
                ...
                `}
              >
                <div className="w-5 h-5 rounded-md bg-[var(--component-card)]/20 flex items-center justify-center">
                  {isRecording ? (
                    <Square className="w-3 h-3 text-[var(--foreground)]" />
                  ) : (
                    <Mic className="w-3 h-3 text-[var(--foreground)]" />
                  )}
                </div>
