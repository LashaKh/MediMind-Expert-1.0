        ...
        <div className="relative bg-gradient-to-r from-red-50 via-rose-50 to-pink-50 dark:from-red-900/20 dark:via-rose-900/20 dark:to-pink-900/20 border border-red-200/40 dark:border-red-700/40 rounded-2xl p-6 mb-6 shadow-lg shadow-red-500/10 overflow-hidden">
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center space-x-6">
              ...
              {/* Premium Timer */}
              <div className="flex items-center space-x-3 bg-[var(--component-card)]/60 dark:bg-[var(--background)]/60 backdrop-blur-sm rounded-xl px-4 py-2 border border-red-200/30 dark:border-red-700/30">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                <Volume2 className="w-5 h-5 text-[var(--foreground-tertiary)] dark:text-slate-400" />
                ...
                <span className="text-sm font-bold text-[var(--foreground)] dark:text-slate-300 min-w-[40px]">
            ...
            <div className="flex items-center space-x-6">
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-green-600 flex items-center justify-center shadow-lg shadow-emerald-500/25">
                  <Sparkles className="w-6 h-6 text-[var(--foreground)] animate-spin" />
                </div>
      ...
      {recordingState.isProcessingChunks && recordingState.totalChunks > 0 && (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/10 dark:to-indigo-900/10 border border-blue-200/50 dark:border-blue-700/30 rounded-xl p-4 mb-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-3">
              <div className="w-5 h-5 border-2 border-[var(--cardiology-accent-blue)]/30 border-t-blue-500 rounded-full animate-spin" />
              <span className="text-[var(--cardiology-accent-blue-dark)] dark:text-blue-300 font-semibold">
                Processing: {recordingState.processedChunks}/{recordingState.totalChunks} chunks
              </span>
            </div>
            <span className="text-[var(--cardiology-accent-blue-dark)] dark:text-blue-400 text-xs font-medium">
              {Math.round((recordingState.processedChunks / recordingState.totalChunks) * 100)}%
            </span>
          </div>
          <div className="w-full bg-[var(--cardiology-accent-blue-medium)] dark:bg-[var(--cardiology-accent-blue-darker)]/30 rounded-full h-2.5">
            <div 
