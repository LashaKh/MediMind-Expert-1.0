    ...
    <div className={`flex flex-col items-center justify-center min-h-[400px] p-8 space-y-6 ${className}`}>
      ...
      <div className="relative">
        ...
        <div className="relative p-6 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-2xl shadow-lg">
          <Calculator className="w-12 h-12 text-[var(--cardiology-accent-blue-dark)] dark:text-blue-400 animate-bounce" />
          {/* Floating sparkles */}
      ...
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-[var(--foreground-tertiary)] dark:text-[var(--foreground-secondary)] max-w-md">
      ...
      <div className="flex items-center space-x-2">
        <Loader2 className="w-5 h-5 text-[var(--cardiology-accent-blue-dark)] animate-spin" />
        <div className="flex space-x-1">
          <div className="w-2 h-2 bg-[var(--cardiology-accent-blue-dark)] rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
